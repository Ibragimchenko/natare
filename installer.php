...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210319_svitpopkornu_ac8223e73b31baf99503_20210802135159_archive.zip';
	const ARCHIVE_SIZE		 = '104055355';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ac8223e-02135159';
    const SECONDARY_PACKAGE_HASH = '463efa7-02135159';
	const VERSION			 = '1.4.1';
